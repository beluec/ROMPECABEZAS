...
var instrucciones = [["Podes usar las flechas del teclado para mover las piezas"], ["Mové todas las piezas necesarias hasta alcanzar la imagen objetivo"]];
...
function chequearSiGano() {
  ...
  for (var y = 0; y <= 2; y++) {
    for (var x = 0; x <= 2; x++) {
      var correct = (y * 3) + x + 1;
      if (grilla[y][x] !== correct) return false;
    }
  }
  return true;
}
...
function mostrarCartelGanador() {
    alert("Has completado el rompecabezas exitosamente");
    var juegoNuevo = prompt("¿Deseas volver a jugar? \n 1. SI \n 2. NO");
    switch (juegoNuevo){
      case "1":
        mezclarPiezas(30);
        break;
